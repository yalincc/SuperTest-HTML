...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable">
				...
				<tbody>
					<tr data-constructor="JXG.Util.Unzip" data-description="">
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable">
					...
					<tbody>
   						...
   						<tr data-methods="nextFile" data-returns="Boolean" data-signature="[]" data-description="nextFile:
Extract the next file from the compressed archive.
Calls skipdir() to proceed recursively." data-ignore="">
...
Extract the next file from the compressed archive.</div>
   						...
   						<tr data-methods="skipdir" data-returns="Boolean" data-signature="[]" data-description="Test if the end of the files' data part of the archive has baseElement
reached. If not, uncompressing is resumed." data-ignore="ignore ">
