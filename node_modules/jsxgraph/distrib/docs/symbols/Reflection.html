...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable">
				...
				<tbody>
					<tr data-constructor="Reflection" data-description="A reflected element (point, polygon, line or curve) is given by a given
...
<!-- ============================== attributes summary ===================== -->
				...
				<table class="summaryTable">
					...
					<tbody>
						...
						<tr data-attributes="center" data-type="center" data-description="Attributes of circle center, i.e. the center of the circle,
if a circle is the mirror element and the transformation type is 'Euclidean'" data-ignore="">
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">
						...
						<tr data-attributes="type" data-type="String" data-description="Type of transformation. Possible values are 'Euclidean', 'projective'.

If the value is 'Euclidean', the reflected element of a circle is again a circle,
otherwise it is a conic section." data-ignore="">
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont">
