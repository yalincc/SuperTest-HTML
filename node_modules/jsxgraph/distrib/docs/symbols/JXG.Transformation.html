...
<!-- ============================== constructor summary ==================== -->
			...
			<table class="summaryTable">
				...
				<tbody>
					<tr data-constructor="JXG.Transformation" data-description="A transformation consists of a 3x3 matrix, i.e.">
						<td class="attributes">&nbsp;</td>
						<td class="nameDescription" >
							<div class="fixedFont">
								<b><a href="../symbols/JXG.Transformation.html#constructor">JXG.Transformation</a></b>(board, type, params, is3D)
							</div>
...
<!-- ============================== methods summary ======================== -->
				...
				<table class="summaryTable">
					...
					<tbody>
   						...
   						<tr data-methods="apply" data-returns="Array" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;JXG.GeometryElement&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;p&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;element which is transformed&amp;quot;},{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;String&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;&amp;#39;self&amp;#39;&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;Apply the transformation to the initialCoords instead of the coords if this is set.&amp;quot;}]" data-description="Transform a point element, that are: {@link Point}, {@link Text}, {@link Image}, {@link Point3D}.
First, the transformation matrix is updated, then do the matrix-vector-multiplication.
&lt;p&gt;
Restricted to 2D transformations." data-ignore="ignore ">

							<td class="attributes">&lt;private&gt; &nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#apply">apply</a></b>(p, 'self')
								</div>
								<div class="description">Transform a point element, that are: <a href="../symbols/Point.html">Point</a>, <a href="../symbols/Text.html">Text</a>, <a href="../symbols/Image.html">Image</a>, <a href="../symbols/Point3D.html">Point3D</a>.</div>
							</td>
						</tr>
					
   						<tr data-methods="applyOnce" data-returns="" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;JXG.Point|Array&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;p&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;&amp;quot;}]" data-description="Applies a transformation once to a point element, that are: {@link Point}, {@link Text}, {@link Image}, {@link Point3D} or to an array of such elements.
If it is a free 2D point, then it can be dragged around later
and will overwrite the transformed coordinates." data-ignore="">

							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#applyOnce">applyOnce</a></b>(p)
								</div>
								<div class="description">Applies a transformation once to a point element, that are: <a href="../symbols/Point.html">Point</a>, <a href="../symbols/Text.html">Text</a>, <a href="../symbols/Image.html">Image</a>, <a href="../symbols/Point3D.html">Point3D</a> or to an array of such elements.</div>
							</td>
						</tr>
					
   						<tr data-methods="bindTo" data-returns="" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;Array|JXG.Object&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;el&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;JXG.Object or array of JXG.Object to\n                           which the transformation is bound to.&amp;quot;}]" data-description="Binds a transformation to a GeometryElement or an array of elements. In every update of the
...
It is not fused (melt) with an existing transformation." data-ignore="">

							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#bindTo">bindTo</a></b>(el)
								</div>
								<div class="description">Binds a transformation to a GeometryElement or an array of elements.</div>
							</td>
						</tr>
					
   						<tr data-methods="clone" data-returns="JXG.Transformation" data-signature="[]" data-description="Create a copy of the transformation in case it is static, i.e.
if the transformation matrix does not depend on other elements.
&lt;p&gt;
If the transformation matrix is not static, null will be returned." data-ignore="">

							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#clone">clone</a></b>()
								</div>
								<div class="description">Create a copy of the transformation in case it is static, i.e.</div>
							</td>
						</tr>
					
   						<tr data-methods="melt" data-returns="JXG.Transform" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;JXG.Transform&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;t&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;Transformation which is the left multiplicand&amp;quot;}]" data-description="Combine two transformations to one transformation. This only works if
...
i.e. (this) = (t) join (this)" data-ignore="">
   						...
   						<tr data-methods="meltTo" data-returns="" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;Array|JXG.Object&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;el&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;JXG.Object or array of JXG.Objects to\n                           which the transformation is bound to.&amp;quot;}]" data-description="Binds a transformation to a GeometryElement or an array of elements. In every update of the
GeometryElement(s), the transformation is executed. That means, in order to immediately
...
to prevent side effects." data-ignore="">

							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#meltTo">meltTo</a></b>(el)
								</div>
								<div class="description">Binds a transformation to a GeometryElement or an array of elements.</div>
							</td>
						</tr>
					
   						<tr data-methods="setAttribute" data-returns="" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;Object&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;term&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;Key-value pairs of the attributes.&amp;quot;}]" data-description="Empty method. Unused." data-ignore="">
   						...
   						<tr data-methods="setMatrix" data-returns="" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;JXG.Board&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;board&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;&amp;quot;},{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;String&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;type&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;Transformation type, possible values are\n                       &amp;#39;translate&amp;#39;, &amp;#39;scale&amp;#39;, &amp;#39;reflect&amp;#39;, &amp;#39;rotate&amp;#39;,\n                       &amp;#39;shear&amp;#39;, &amp;#39;generic&amp;#39;.&amp;quot;},{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;Array&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;params&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;Parameters for the various transformation types.\n\n&amp;lt;p&amp;gt;A transformation with a generic matrix looks like:\n&amp;lt;pre&amp;gt;\n( a  b  c )   ( z )\n( d  e  f ) * ( x )\n( g  h  i )   ( y )\n&amp;lt;/pre&amp;gt;\n\nThe transformation matrix then looks like:\n&amp;lt;p&amp;gt;\nTranslation matrix:\n&amp;lt;pre&amp;gt;\n( 1  0  0)   ( z )\n( a  1  0) * ( x )\n( b  0  1)   ( y )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nScale matrix:\n&amp;lt;pre&amp;gt;\n( 1  0  0)   ( z )\n( 0  a  0) * ( x )\n( 0  0  b)   ( y )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nA rotation matrix with angle a (in Radians)\n&amp;lt;pre&amp;gt;\n( 1    0        0      )   ( z )\n( 0    cos(a)   -sin(a)) * ( x )\n( 0    sin(a)   cos(a) )   ( y )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nShear matrix:\n&amp;lt;pre&amp;gt;\n( 1  0  0)   ( z )\n( 0  1  a) * ( x )\n( 0  b  1)   ( y )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;Generic transformation (9 parameters):\n&amp;lt;pre&amp;gt;\n( a  b  c )   ( z )\n( d  e  f ) * ( x )\n( g  h  i )   ( y )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;Matrix:\n&amp;lt;pre&amp;gt;\n(         )   ( z )\n(    M    ) * ( x )\n(         )   ( y )\n&amp;lt;/pre&amp;gt;&amp;quot;}]" data-description="Set the transformation matrix for different types of standard transforms." data-ignore="">

							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#setMatrix">setMatrix</a></b>(board, type, params)
								</div>
								<div class="description">Set the transformation matrix for different types of standard transforms.</div>
							</td>
						</tr>
					
   						<tr data-methods="setMatrix3D" data-returns="" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;JXG.Board&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;board&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;&amp;quot;},{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;String&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;type&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;Transformation type, possible values are\n                       &amp;#39;translate&amp;#39;, &amp;#39;scale&amp;#39;, &amp;#39;rotate&amp;#39;,\n                       &amp;#39;rotateX&amp;#39;, &amp;#39;rotateY&amp;#39;, &amp;#39;rotateZ&amp;#39;,\n                       &amp;#39;shear&amp;#39;, &amp;#39;generic&amp;#39;.&amp;quot;},{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;Array&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;params&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;Parameters for the various transformation types.\n\n&amp;lt;p&amp;gt;A transformation with a generic matrix looks like:\n&amp;lt;pre&amp;gt;\n( a  b  c  d)   ( w )\n( e  f  g  h) * ( x )\n( i  j  k  l)   ( y )\n( m  n  o  p)   ( z )\n&amp;lt;/pre&amp;gt;\n\nThe transformation matrix then looks like:\n&amp;lt;p&amp;gt;\nTranslation matrix:\n&amp;lt;pre&amp;gt;\n( 1  0  0  0)   ( w )\n( a  1  0  0) * ( x )\n( b  0  1  0)   ( y )\n( c  0  0  1)   ( z )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nScale matrix:\n&amp;lt;pre&amp;gt;\n( 1  0  0  0)   ( w )\n( 0  a  0  0) * ( x )\n( 0  0  b  0)   ( y )\n( 0  0  0  c)   ( z )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nrotateX: a rotation matrix with angle a (in Radians)\n&amp;lt;pre&amp;gt;\n( 1    0        0             )   ( z )\n( 0    1        0         0   ) * ( x )\n( 0    0      cos(a)   -sin(a)) * ( x )\n( 0    0      sin(a)   cos(a) )   ( y )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nrotateY: a rotation matrix with angle a (in Radians)\n&amp;lt;pre&amp;gt;\n( 1      0       0           )   ( z )\n( 0    cos(a)    0    -sin(a)) * ( x )\n( 0      0       1       0   ) * ( x )\n( 0    sin(a)    0    cos(a) )   ( y )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nrotateZ: a rotation matrix with angle a (in Radians)\n&amp;lt;pre&amp;gt;\n( 1      0                0  )   ( z )\n( 0    cos(a)   -sin(a)   0  ) * ( x )\n( 0    sin(a)   cos(a)    0  )   ( y )\n( 0      0         0      1  ) * ( x )\n&amp;lt;/pre&amp;gt;\n\n&amp;lt;p&amp;gt;\nrotate: a rotation matrix with angle a (in Radians)\nand normal &amp;lt;i&amp;gt;n&amp;lt;/i&amp;gt;.&amp;quot;}]" data-description="Set the 3D transformation matrix for different types of standard transforms." data-ignore="">

							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/JXG.Transformation.html#setMatrix3D">setMatrix3D</a></b>(board, type, params)
								</div>
								<div class="description">Set the 3D transformation matrix for different types of standard transforms.</div>
							</td>
						</tr>
					
   						<tr data-methods="setProperty" data-returns="" data-signature="[{&amp;quot;title&amp;quot;:&amp;quot;param&amp;quot;,&amp;quot;type&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;name&amp;quot;:&amp;quot;term&amp;quot;,&amp;quot;isOptional&amp;quot;:false,&amp;quot;defaultValue&amp;quot;:&amp;quot;&amp;quot;,&amp;quot;desc&amp;quot;:&amp;quot;&amp;quot;}]" data-description="Unused" data-ignore="ignore">
   						...
   						<tr data-methods="update" data-returns="JXG.Transform" data-signature="[]" data-description="Updates the numerical data for the transformation, i.e. the entry of the subobject matrix." data-ignore="">
...
<!-- ============================== constructor details ==================== -->
			...
			<div class="details"><a name="constructor"> </a>
				...
				<div class="fixedFont">
						<b>JXG.Transformation</b>(board, type, params, is3D)
				</div>
					...
					A transformation consists of a 3x3 matrix, i.e. it is a projective transformation.
						...
						<dl class="detailList">
							...
							<dt>
								...
								<dd>The board the transformation is part of.</dd><br><br>
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<div class="description">
						Transform a point element, that are: <a href="../symbols/Point.html">Point</a>, <a href="../symbols/Text.html">Text</a>, <a href="../symbols/Image.html">Image</a>, <a href="../symbols/Point3D.html">Point3D</a>.
First, the transformation matrix is updated, then do the matrix-vector-multiplication.
<p>
Restricted to 2D transformations.
					...
					<div class="description">
						Applies a transformation once to a point element, that are: <a href="../symbols/Point.html">Point</a>, <a href="../symbols/Text.html">Text</a>, <a href="../symbols/Image.html">Image</a>, <a href="../symbols/Point3D.html">Point3D</a> or to an array of such elements.
If it is a free 2D point, then it can be dragged around later
...
It is not fused (melt) with an existing transformation.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dt>
									<span class="light fixedFont">{Array|JXG.Object}</span> <b>el</b>
                           ...
                           which the transformation is bound to.</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd>JXG.Transformation.meltTo</dd>
					...
					<span class="light">{<a href="../symbols/JXG.Transformation.html">JXG.Transformation</a>}</span>
					<b>clone</b>()
...
If the transformation matrix is not static, null will be returned.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{<a href="../symbols/JXG.Transformation.html">JXG.Transformation</a>}</span> </dd>
...
to prevent side effects.
							...
							<dt class="heading">Parameters:</dt>
								...
								<dd>JXG.Object or array of JXG.Objects to
                           which the transformation is bound to.</dd>
							...
							<dt class="heading">See:</dt>
								...
								<dd><a href="../symbols/JXG.Transformation.html#bindTo">JXG.Transformation#bindTo</a></dd>
					...
					<b>setMatrix</b>(board, type, params)
...
(         )   ( y )
					...
					<a name="setMatrix3D"> </a>
					<div class="fixedFont">

					
					<b>setMatrix3D</b>(board, type, params)
